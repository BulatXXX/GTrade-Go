...
func (r *AuthRepository) CreateUser(ctx context.Context, email, passwordHash, role string) (*User, error) {
	query := `
...
func (r *AuthRepository) UpdateUserRole(ctx context.Context, userID int64, role string) (*User, error) {
	var user User
