...
func NewRouterWithSecurity(logger zerolog.Logger, h *handler.Handler, jwtSecret, internalToken string) *gin.Engine {
	...
	registerServiceRoutes(r, h, jwtSecret, internalToken)
