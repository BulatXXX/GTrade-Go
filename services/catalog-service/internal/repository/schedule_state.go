...
func (r *CatalogRepository) AcquireSchedulerLock(ctx context.Context, lockKey int64) (bool, func(), error) {
...
func (r *CatalogRepository) MarkSchedulerStarted(ctx context.Context, jobName string, startedAt time.Time) error {
...
func (r *CatalogRepository) MarkSchedulerFinished(ctx context.Context, jobName string, finishedAt time.Time, runErr error, processed, total int) error {
	status := "ok"
	var errStr *string
	if runErr != nil {
		status = "error"
...
func (r *CatalogRepository) ListSchedulerStates(ctx context.Context) ([]SchedulerState, error) {
